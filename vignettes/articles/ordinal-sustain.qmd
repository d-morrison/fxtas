---
title: "Progression of Fragile X-associated tremor/ataxia syndrome revealed by Subtype and Stage Inference"
format:
  html:
    echo: false
  docx: default
...
**Running title:** FXTAS progression revealed by SuStaIn{{< pagebreak >}}
...
stages = v1_usable_cases |> dplyr::select(`FXTAS Stage`) |> table()
biomarkers_table = 
  v1_usable |> 
