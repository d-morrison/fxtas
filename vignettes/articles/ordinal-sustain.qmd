...
# [Abstract word limit: 400]{.comment-start author="Ezra Morrison"} Abstract {.unnumbered} []{.comment-end}
...
PVDs are heatmaps with symptomatic events on the y-axis 
...
stratified by sex.
We found statistically significant evidence of sex differences in 
...
that are 
relatively homogeneous within the same cluster 
and heterogeneous from other clusters 
in terms of sequential patterns. 
