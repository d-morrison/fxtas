...
[David proposed the title: 
"Development and progression of Fragile X-associated tremor/ataxia
syndrome revealed by Ordinal SuStaIn analysis".
The ordinal nature of the data seems incidental to me, 
but maybe it’s worth name-checking the SuStaIn algorithm 
for Search Engine Optimization purposes?
Maybe 
“Modeling Fragile X-associated tremor/ataxia syndrome 
development and progression using the Subtype and Stage Inference algorithm”?
]{.comment-start}
[]{.comment-end}
