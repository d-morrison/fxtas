...
v1_usable = full_data |> filter(CGG < 200) |>
  mutate(`FX3*` = `FX3*` |> forcats::fct_drop() |> 
           labelled::set_label_attribute("CGG Level"))
...
unstratified dataset [Supplementary Figure @fig-cvic-1]. 
The out-of-fold log-likelihood ("OOFLL") (Supplementary Materials, @sec-subtypes) 
showed substantial fold-to-fold variation [Supplementary Figure @fig-cvic-2].
...
[Supplementary Figure @fig-pvd-by-cgg]. 
