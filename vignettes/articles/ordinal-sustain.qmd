...
## Stratified by CGG repeats within sex
...
It appears that the model reaches optimum CVIC at `r which.min(temp$CVIC)` subtypes. 
For clinical interpretation, we did not want to go beyond 6 subtypes.
