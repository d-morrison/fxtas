---
title: "Development and progression of Fragile X-associated tremor/ataxia
syndrome revealed by Ordinal SuStaIn analysis"
...
For "any autoimmune disorder" and 
five domains of the Structured Clinical Interview for DSM Disorders (SCID), 
we created composite variables 
and used them in the analysis 
(details in Supplementary Materials, @sec-composites).
[Supplemental Tables @tbl-tremors] - [-@tbl-autoimmune] 
summarize the `r outcomes_name` data, 
stratified by 
...
also appear at earlier stages for males than for females.
...
With `r n_events` symptoms included in the analysis, it is 
challenging to concisely summarize the differences 
between the detected subtypes.
Roughly speaking:
Subtype 1 appeared to 
experience mood disorders before FXTAS Stage 1,
tremors and ataxia between Stages 1 and 4,
parkinsonian features between Stages 3 and 4,
and brain abnormalities between Stages 4 and 5.
Compared to Subtype 1, Subtype 2 appeared to experience 
brain abnormalities earlier (between Stages 2 and 4),
tremors and ataxia later (between Stages 2 and 4).
parkinsonian features later (between stages 4 and 5),
and mood disorders later (between Stages 3 and 5),
Subtype 3 appeared to be a mix of Subtypes 1 and 2,
with mood disorders early (before Stage 1, like Subtype 1),
brain abnormalities also early (between Stages 1 and 3, like Subtype 2), 
and parkinsonian features later (between Stages )
...
and
substance use
at earlier FXTAS stages than Subtype 1,
and appeared to experience 
mood disorders,
postural tremor,
pill rolling tremor,
stiff gait,
increased tone, and
masked faces
at later FXTAS stages than Subtype 1.

Subtype 3 appeared to experience
MRI abnormalities
MRI cerebellar abnormalities
and cognitive impairment (MMSE score decline)
even earlier than Subtype 2
and
head tremor,
substance use,
postural tremor,
resting tremor
later than Subtype 2
...
earlier in the event sequence than Subtype 1.
