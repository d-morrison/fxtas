...
We found significant evidence of sex differences in proportions of events at baseline visit for `r report_sex_differences(biomarkers_table)`.
...
#| fig-cap: !expr glue::glue("**Event sequence models stratified by sex. \\(a\\)** Estimated event sequences models, stratified by sex. **(b)** Positional differences in estimated event sequence between sexes. {compact_fig_caption}")
#| layout-ncol: 1
#| fig-subcap: 
#|    - "(a)"
#|    - " "
