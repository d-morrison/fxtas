...
The z-score SuStaIn algorithm (@young2018uncovering) 
is designed to be used with 
There are other methods available for analyzing continuous measures (), 
and it may be possible to fit a model that combines both cotninous and ordinal outcomes. 
Possible future work could attempt this combination.

### Comparison with longitudinal data



We don’t really have accurate data for age onset, so we cannot easily confirm our results. Additional research including longitudinal data collecting age of onset would be needed to to verify our findings.
...
#| layout-ncol: 1
#| fig-subcap: 
#|    - "Estimated event sequences models, stratified by sex"
...
#| fig-height: !expr pvd_height
#| fig-width: !expr pvd_width
#| fig-cap: !expr glue::glue("positional variance diagrams for {n_s_selected} subtypes and comparisons of event sequences between subtypes. {compact_fig_caption}") 
#| fig-cap-location: top
#| layout-ncol: 1
#| layout-nrow: 4
#| fig-subcap: 
