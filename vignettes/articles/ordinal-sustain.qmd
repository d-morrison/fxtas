...
We did not find statistically significant evidence of a difference between CGG < 100 and CGG ≥ 100 among females (p = `r pval_female_cgg_gp34_v1`). @fig-pvd-by-cgg-female shows the estimated stratified models, and @fig-pvd-by-cgg-female-change compares the maximum likelihood estimates. Here again, sample size was an issue, especially since the available data included only `r n_over100_Female` females with CGG ≥ 100.
