...
The fragile X-associated tremor/ataxia syndrome (FXTAS) is a relatively newly discovered neurodegenerative disorder caused by the premutation (55 to 200 CGG repeats) in the FMR1 gene.
...
Here, we applied the Ordinal **Su**btype and **St**age **In**ference ("SuStaIn") algorithm to find event sequences for FXTAS patients.
We found substantial differences in order of onset depending on sex and CGG repeat number.
...
We also fit the Ordinal SuStaIn model, stratified by sex, 
