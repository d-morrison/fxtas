...
Figure + table limit: 8.]{.mark}{{< pagebreak >}}
...
Based on the CVIC criterion (Supplementary material, @sec-subtypes), 
...
The out-of-fold log-likelihood ("OOFLL") (Supplementary material, @sec-subtypes) 
