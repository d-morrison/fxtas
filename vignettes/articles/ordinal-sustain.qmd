...
The study protocols changed over the years (`r min_year` - `r max_year`) 
...
and between lower (CGG <100) and higher premutation levels (CGG 100-199),
...
#| fig-cap: !expr glue::glue("**Event sequence models stratified by sex. (a)** {compact_fig_caption} **(b)** Positional differences in estimated event sequence between sexes. {compact_fig_cap2}")
#| layout-ncol: 1
#| fig-subcap: 
#|    - " "
#|    - " "
