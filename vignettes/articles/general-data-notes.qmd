...
variable (`"any autoimmune disorder"`)was created for analysis: `"Yes"` if a patient had any of Lupus, Rheumatoid arthritis, 
Multiple Sclerosis, ANA positive, Sjogren's Syndrome, Raynaud's Syndrome, 
or Pulmonary Fibrosis; otherwise, `"No"` for no autoimmune diseases recorded.

#### MRI variables  

The MRI variables are combined into composite variables taking the most severe score within a brain region.  

-   MRI Cerebellar: the most severe score of Cerebellar atrophy, Cerebellar WM hyperintensity, and MCP-WM hyperintensitity.  
-   MRI Cerebral: the most severe score of Cerebral atrophy, Cerebral WM hyperintensity, Pons-WM hyperintensity, Sub-insular WM hyperintensity, Preiventricular WM hyperintensity.  


Splenium-WM hyperintensity, Genu-WM hyperintensity, and Corpus Callosum-Thickness remain as separate fields.  
...
among the constit,ent individual disorders.
Specifically:
