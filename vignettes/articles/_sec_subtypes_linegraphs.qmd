...
figs[c(1, 2)] |> pvd_lineplot(y_text_size = y_text_size)
...
figs[c(1, 3)] |> pvd_lineplot(y_text_size = y_text_size)
...
figs[c(1, 4)] |> pvd_lineplot(y_text_size = y_text_size)
...
figs[c(2, 3)] |> pvd_lineplot(y_text_size = y_text_size)
...
figs[c(2, 4)] |> pvd_lineplot(y_text_size = y_text_size)
...
figs[c(3, 4)] |> pvd_lineplot(y_text_size = y_text_size)
