...
table1a(
  ...
  stratified_formula(vars, column_var),
  # render.continuous = c(.="N", .="Mean (SD)", .="Median [Min,  Max]"),
  data = visit1_cgg_55_199 |> filter(Study == "GP4"),
  footnote = footnote)
...
table1a(
  ...
  stratified_formula(vars, column_var),
  # render.continuous = c(.="N", .="Mean (SD)", .="Median [Min,  Max]"),
  data = visit1_cgg_55_199 |> filter(Study == "GP4" & `Head tremor` == "Yes"))
...
table1a(
  ...
  stratified_formula(vars, column_var),
  footnote = 'For `MMSE Total Score`, codes `777`, `888`, and `999` are counted as "Missing" (NA).',
  # render.continuous = c(.="N", .="Mean (SD)", .="Median [Min,  Max]"),
  data = visit1_cgg_55_199)
