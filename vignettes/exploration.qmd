...
Here, we review the data from the first visits by each participant, stratified by `r strat_text`.
...
```{r}
#| fig-cap: "MOCA scores by age and CGG category"
#| label: moca-graph-1
...
gp34 |> 
  ...
  labs(col = "MOCA cutoff") + 
  geom_point(alpha = .6, aes(col = Gender))
...
Following @thomann2020enhanced, we categorized MOCA as Below 23 = "pathological", 
24-26 = “transitional", and 27 and above = "healthy".
