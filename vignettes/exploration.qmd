...
For SCL90 scores, missing codes and blanks are treated as no data. For analysis with the Ordinal SuStaIn method, we dichotomized each score as clinically elevated (60+) vs not.
...
purdue_vars = c(
  ...
  "Purdue pegboard 1st Trial Total, R+L+B: missingness"
)
table1(
  NA.label = NA.label1,
