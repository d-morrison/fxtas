...
pval_sex_gp34_v1 = compute_permutation_pvalue(
...
The data provided statistically significant evidence of a difference in event sequences between males and females (p `r pval_sex_gp34_v1 |> scales::pvalue()`).
...
pval_cgg_gp34_v1 = compute_permutation_pvalue(
  observed_test_stat = observed_test_stat,
  permuted_test_stats = permuted_test_stats
)
