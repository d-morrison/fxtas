...
To test for differences in event sequence between males and females and between lower premutation levels (CGG <100) versus higher premutation levels (CGG 100-199), we implemented a permutation test, in which we created 1000 permuted datasets in which the strata variables were randomly shuffled. 
