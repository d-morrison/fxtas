...
We can choose an optimal number of clusters using the Cross-Validation Information Criterion (CVIC) [@young2018uncovering, @gelman2014understanding] (@fig-cvic).
...
```{r}
#| label: "fig-pvd1_by_sex"
#| column: screen
#| fig-height: 15
#| fig-align: center
#| fig-cap: "positional variance diagram for 1 subgroup, stratified by sex"
#| fig-cap-location: top
#| layout-ncol: 2
#| fig-subcap: 
#|   - "Males"
