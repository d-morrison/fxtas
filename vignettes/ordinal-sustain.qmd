...
#| caption: Bar-plot of CGG repeats among GP/GP4 participants
...
```{r}
n_missing_CGG = visit1$"FX*" |> is.na() |> sum()
...
We also considered adding Trax data for the stratified analysis of males (@fig-trax).
...
fig_trax_only = extract_figs_from_pickle(
  ...
  output_folder = "output/mdp/trax_visit1")
