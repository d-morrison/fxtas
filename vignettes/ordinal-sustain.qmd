...
We first fit the model using the first visit after age 40 for each participant in GP+GP4+Trax, assuming one shared event sequence (no latent subgroups; see @fig-first-only-1).
