...
gp34_v1_usable = full_data |> filter(CGG < 200)
...
@tbl-demographics provides demographic information about the study participants. @tbl-apoe - @tbl-autoimmune summarize the biomarker data, stratified by CGG (`r unique(visit1_cgg_complete$"FX3*")`) 
