...
We fit models stratified by sex (no latent subgroups; see @fig-first-only-1 and @fig-first-only-2).

We also fit the model stratified by CGG repeats (<100 vs $\ge$ 100), also with no latent subgroups (see @fig-pvd-by-cgg).

We also fit the models stratified by both sex and CGG repeats (<100 vs $\ge$ 100), also with no latent subgroups (results in @sec-stratified-by-cgg-and-sex).
