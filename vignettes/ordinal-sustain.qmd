...
sus_output = sustain_input$run_sustain_algorithm(plot= FALSE)
```
...
sustain_input_males = pySuStaIn.OrdinalSustain(r.prob_nl,
r.prob_score,
r.score_vals,
r.SuStaInLabels,
r.N_startpoints,
...
:::{.content-visible when-profile="cv"}
