...
The vast majority of the `MRI` data are missing, data are completely missing in GP3 and largely missing for those in GP4.
...
The list of patients in GP4 with any missing `MRI` data are shown below:
