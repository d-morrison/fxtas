...
table1(
  NA.label = NA.label1,
  stratified_formula("Tremor: Age of onset: missingness", "Recruited in study phase"),
...
table1(
  NA.label = NA.label1,
  stratified_formula("Head Tremor: Age of onset: missingness", "Recruited in study phase"),
...
vars = grep("Interviewers Diagnosis \\d+,  by Code", value = TRUE, names(gp34)) |> sort()
vars = grep("Interviewers Diagnosis", value = TRUE, names(gp34)) |> sort()
...
**Question:** Do we want to include "Interpersonal Sensitivity T-score" (was included in data extract, wasn't on Word doc list)?

```{r}

vars = c(
  # grep("score", value = TRUE, names(gp34), ignore.case = TRUE) |> sort(),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Somatization (T-score)"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Obsessive-Compulsive (T-score)"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Depression (T-score)"), 
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Anxiety (T-score)"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Hostility (T-score)"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Phobia (T-score)"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Paranoid Ideation (T-score)",),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Psychoticism (T-score)"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Global Severity Index (T-score)"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Interpersonal Sensitivity T-score"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Positive Symptom Distress Index (T-score)"),
  grep(value = TRUE, fixed = TRUE, names(gp34), pattern = "Positive Symptom Total (T-score)")
)
...
**Question:** Do we want to include "Interpersonal Sensitivity T-score" in the analysis? (It was included in data extract but wasn't in the Word document "FXTAS event sequence RH.docx").
