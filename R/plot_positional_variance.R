plot_positional_var = function(
    ...
    ml_f_EM=NULL,
    cval=False, subtype_order=NULL, biomarker_order=NULL, title_font_size=12, stage_font_size=10, stage_label='SuStaIn Stage', stage_rot=0, stage_interval=1, label_font_size=10, label_rot=0, cmap="original", biomarker_colours=NULL, figsize=NULL, subtype_titles=NULL, separate_subtypes=False, save_path=NULL, save_kwargs={})
{
