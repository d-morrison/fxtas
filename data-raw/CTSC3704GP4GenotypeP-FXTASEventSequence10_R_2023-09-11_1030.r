...
library(Hmisc)
#Read Data
data=read.csv('CTSC3704GP4GenotypeP-FXTASEventSequence10_DATA_2023-09-11_1030.csv')
#Setting Labels
...
label(data$kin_l_resttrem)="Kinesia Left Rest Tremor"
label(data$kin_l_posttrem)="Kinesia Left Postural Tremor"
label(data$kin_l_kintrem)="Kinesia Left Kinetic Tremor"
label(data$kin_r_resttrem)="Kinesia Right Rest Tremor"
label(data$kin_r_posttrem)="Kinesia Right Postural Tremor"
label(data$kin_r_kintrem)="Kinesia Right Kinetic Tremor"
label(data$pp_t1rlb_total)="Purdue pegboard 1st Trial Total, R+L+B"
label(data$moca_tot_score)="MOCA Total score"
#Setting Units
