...
library(Hmisc)
#Read Data
data=read.csv('GPGenotypePhenotypeR-FXTASEventSequence10_DATA_2023-09-13_1001.csv')
#Setting Labels
...
levels(data$mds_ne_pf.factor)=c("No","Yes","No Response","Question not asked at time of data entry; check records")
