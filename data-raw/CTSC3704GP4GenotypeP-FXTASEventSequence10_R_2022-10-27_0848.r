...
labels = c(subj_id = "FXS ID",
           ...
           sex = "Gender", visit_age = "Age at visit", mol_apoe = "ApoE",
           mol_dna_result = "Floras Non-Sortable Allele Size (CGG) Results",
           new_mds_psy_drug = "Drug use", new_mds_psy_drug_notes = "Drugs used",
           new_mds_psy_drug_marij = "Marijuana use", new_mds_psy_alco = "Alcohol abuse",
           new_mds_psy_dri = "# of drinks per day now", new_mds_med_thyca = "Thyroid Cancer",
           new_mds_med_skin = "Skin Cancer", new_mds_med_mela = "Melanoma",
           new_mds_med_proca = "Prostate Cancer", new_mds_med_sur1 = "Surgery: Type/Age",
           new_mds_med_sur2 = "Surgery 2: Type/Age", new_mds_med_sur3 = "Surgery 3: Type/Age",
           new_mds_med_sur4 = "Surgery 4: Type/Age", new_mds_med_sur5 = "Surgery 5: Type/Age",
           new_mds_neu_trem_int = "Intention tremor", new_mds_neu_trem_rest = "Resting tremor",
           ...
           new_mds_neu_atax_age = "Age of onset", new_mds_ne_ga = "Ataxia",
