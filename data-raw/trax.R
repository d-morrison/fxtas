...
# new SCID variable (03-2024)
dataset$scid_md05lif = factor(dataset$scid_md05lif,levels=c("777","1","2","3"))
dataset$scid_md06lif = factor(dataset$scid_md06lif,levels=c("777","1","2","3"))
dataset$scid_md06cur = factor(dataset$scid_md06cur,levels=c("1","3"))
dataset$scid_sud17lif = factor(dataset$scid_sud17lif,levels=c("777","1","2","3"))
dataset$scid_sud17cur = factor(dataset$scid_sud17cur,levels=c("1","3"))
dataset$scid_sud18lif = factor(dataset$scid_sud18lif,levels=c("777","1","2","3"))
dataset$scid_sud18cur = factor(dataset$scid_sud18cur,levels=c("1","3"))
dataset$scid_sud19lif = factor(dataset$scid_sud19lif,levels=c("777","1","2","3"))
dataset$scid_sud19cur = factor(dataset$scid_sud19cur,levels=c("1","3"))
dataset$scid_sud20lif = factor(dataset$scid_sud20lif,levels=c("777","1","2","3"))
dataset$scid_sud20cur = factor(dataset$scid_sud20cur,levels=c("1","3"))
dataset$scid_sud21lif = factor(dataset$scid_sud21lif,levels=c("777","1","2","3"))
dataset$scid_sud21cur = factor(dataset$scid_sud21cur,levels=c("1","3"))
dataset$scid_sud22lif = factor(dataset$scid_sud22lif,levels=c("777","1","2","3"))
dataset$scid_sud22cur = factor(dataset$scid_sud22cur,levels=c("1","3"))
dataset$scid_sud23lif = factor(dataset$scid_sud23lif,levels=c("777","1","2","3"))
dataset$scid_sud23cur = factor(dataset$scid_sud23cur,levels=c("1","3"))
dataset$scid_sud24lif = factor(dataset$scid_sud24lif,levels=c("777","1","2","3"))
dataset$scid_sud24cur = factor(dataset$scid_sud24cur,levels=c("1","3"))
dataset$scid_sud25lif = factor(dataset$scid_sud25lif,levels=c("777","1","2","3"))
dataset$scid_sud25cur = factor(dataset$scid_sud25cur,levels=c("1","3"))
dataset$scid_anx26lif = factor(dataset$scid_anx26lif,levels=c("777","1","2","3"))
dataset$scid_anx26cur = factor(dataset$scid_anx26cur,levels=c("1","3"))
dataset$scid_anx27lif = factor(dataset$scid_anx27lif,levels=c("777","1","2","3"))
dataset$scid_anx27cur = factor(dataset$scid_anx27cur,levels=c("1","3"))
dataset$scid_anx28lif = factor(dataset$scid_anx28lif,levels=c("777","1","2","3"))
dataset$scid_anx28cur = factor(dataset$scid_anx28cur,levels=c("1","3"))
dataset$scid_anx29lif = factor(dataset$scid_anx29lif,levels=c("777","1","2","3"))
dataset$scid_anx29cur = factor(dataset$scid_anx29cur,levels=c("1","3"))
dataset$scid_anx30lif = factor(dataset$scid_anx30lif,levels=c("777","1","2","3"))
dataset$scid_anx30cur = factor(dataset$scid_anx30cur,levels=c("1","3"))
dataset$scid_anx31lif = factor(dataset$scid_anx31lif,levels=c("777","1","2","3"))
dataset$scid_anx31cur = factor(dataset$scid_anx31cur,levels=c("1","3"))
dataset$scid_anx32cur = factor(dataset$scid_anx32cur,levels=c("777","1","2","3"))
dataset$scid_anx33lif = factor(dataset$scid_anx33lif,levels=c("777","1","2","3"))
dataset$scid_anx33cur = factor(dataset$scid_anx33cur,levels=c("1","3"))
dataset$scid_anx34lif = factor(dataset$scid_anx34lif,levels=c("777","1","2","3"))
dataset$scid_anx34cur = factor(dataset$scid_anx34cur,levels=c("1","3"))
dataset$scid_anx35lif = factor(dataset$scid_anx35lif,levels=c("777","1","2","3"))
dataset$scid_anx35cur = factor(dataset$scid_anx35cur,levels=c("1","3"))
